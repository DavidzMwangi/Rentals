...
@section('content')
    ...
    <section class="content" id="building_id">
        ...
        <form method="post" action="{{route('landlord.save_new_maintenance')}}">
            {{@csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="room_number_id" required>
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <label for="date_time">Maintenance Date and Time</label>
                    <input id="date_time" type="datetime-local" name="maintenance_date_time" class="form-control" required>
                </div>
            </div>
