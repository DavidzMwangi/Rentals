            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{count(\App\Models\LandLord::all())}}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{count(\App\Models\Tenant::all())}}<sup style="font-size: 20px"></sup></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{count(\App\Models\Apartment::all())}}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>{{count(\App\Models\RoomNumber::where('is_vacant',true)->get())}}</h3>

                            <p>All Vacant Rooms</p>
                        </div>
                        <div class="icon">
